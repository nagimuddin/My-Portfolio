        ...
        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          ...
          <div className="p-6 text-center">
            ...
            <ul className="text-lg flex justify-center gap-1">
              <li>Code Link:</li>
              <li>
                <a href="https://github.com/nagimuddin/Wedding-Photographer" className="text-indigo-500">
                  GitHub Link|
                </a>
              </li>
              <li>
                <a href="https://wedding-photographer-5943c.web.app/" className="text-indigo-500">
                  Live Site
                </a>
              </li>
            </ul>
            <Link to="/project-details3" className="btn btn-wide mt-4">
              Projects Details
            </Link>
          </div>
        </div>
