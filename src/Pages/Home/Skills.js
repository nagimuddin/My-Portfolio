      ...
      <div class="hero min-h-screen bg-base-200">
        <div class="hero-content">
          <div class="text-center lg:text-left">
            <h2 class="py-3">My Skills</h2>
            <h2 class="text-2xl font-bold">Every day <br/>I develop my skills</h2>
            <p className="text-xl">I am a active learner.I always try to learn new in every day. My goal is want to be a full stack developer. Till now I gethard some experience these are.</p>
          </div>
          <div class="w-full grid grid-cols-3 gap-3 bg-base-100 p-8 bg-[#f5655a] mx-auto">
